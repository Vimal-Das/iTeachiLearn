...
const LEVEL_CONFIG = {
    ...
    4: { maxSum: 50, time: 20 },
    5: { maxSum: 70, time: 20 },
    6: { maxSum: 100, time: 15 },
    7: { maxSum: 150, time: 15 },
    8: { maxSum: 200, time: 12 },
    9: { maxSum: 500, time: 12 },
    10: { maxSum: 1000, time: 10 }
};
...
sdk.onInit((data) => {
    ...
    // Start at the unlocked level, or level 1
...
function generateQuestion() {
    ...
    const max = config.maxSum;

    // Generate numbers ensuring sum <= max
